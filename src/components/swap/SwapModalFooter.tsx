...
import { Text, Button } from 'polygon-moonwalkerswap-uikit'
        ...
        <RowBetween>
          <RowFixed>
            ...
            <QuestionHelper
              text={TranslateString(
                999,
                'For each trade a 0.2% fee is paid. 0.17% goes to liquidity providers and 0.03% goes to the MoonwalkerSwap treasury.'
              )}
            />
          </RowFixed>
          <Text fontSize="14px">
