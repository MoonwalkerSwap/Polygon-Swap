...
import { Trade, TradeType } from 'polygon-moonwalkerswap-sdk'
import { Card, CardBody, Text } from 'polygon-moonwalkerswap-uikit'
        ...
        <RowBetween>
          <RowFixed>
            ...
            <QuestionHelper
              text={TranslateString(
                230,
                'For each trade a 0.2% fee is paid. 0.17% goes to liquidity providers and 0.03% goes to the Polygon MoonwalkerSwap treasury.'
              )}
            />
          </RowFixed>
          <Text fontSize="14px">
